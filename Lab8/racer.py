...
road =  pygame.image.load('Lab8/images/road.png')
...
coin = pygame.image.load('Lab8/images/coin.png')
...
class Player(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.image = pygame.image.load('Lab8/images/car1.png')
...
class Car(pygame.sprite.Sprite):
    def __init__(self, x, y):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.image.load('Lab8/images/car2.png')
        self.image.set_colorkey((255, 255, 255))
