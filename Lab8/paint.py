...
pencil = pygame.image.load('Lab8/images/pencil.png')
...
bucket = pygame.image.load('Lab8/images/bucket.png')
bucket = pygame.transform.scale(bucket, (75, 75))

eraser = pygame.image.load('Lab8/images/eraser.png')
eraser = pygame.transform.scale(eraser, (75, 75))

figures = pygame.image.load('Lab8/images/figures.png')
figures = pygame.transform.scale(figures, (75, 75))

pallete = pygame.image.load('Lab8/images/palette.png')
